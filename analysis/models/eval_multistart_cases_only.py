...
_parser.add_argument(
    "--phase_cut_date",
    required=True,
    help="Date string (e.g. 2025-01-31). Parsed to pandas.Timestamp if pandas is installed.",
)
_parser.add_argument(
    "--cutoff_value",
    required=True,
    type=float,
    help="Numeric cutoff value.",
)
_parser.add_argument(
    "--town",
    required=True,
...
def get_ensemble_predictions(model_ids, reporting_delays, t_all, t_phase_1, multistart_result_path, 
    ...
    all_SEIR, all_beta, all_R, all_underrep, all_I7, all_logC, all_shedding, all_noise_params = [], [], [], [], [], [], [], []
